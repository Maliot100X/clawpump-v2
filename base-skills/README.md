# pump-fun-skills (base for ClawPump CLAW fork)

**ClawPump context:** These are the base skills (create-coin, coin-fees, swap, tokenized-agents) forked/adapted for ClawPump + CLAW quote via Meteora DBC. See root README.md + .grok/skills/clawpump-agent/SKILL.md + AGENTS.md for full usage. Use /implement with Grok skills for changes. Never use old KNTWS names in ClawPump code.
